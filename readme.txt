...
+	Fix price on variable product.
+	Fix item_categories on variable product.
+	Added `add_shipping_info` event on order confirmation.
+	Added `add_payment_info` event on order confirmation.
